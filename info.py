...
# Bot information
SESSION = environ.get('SESSION', 'IQDVBOT')
API_ID = int(environ.get('API_ID', '12962251'))
API_HASH = environ.get('API_HASH', 'b51499523800add51e4530c6f552dbc8')
...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/MGIMT")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001906948158'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '833360381').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001962701094').split()]
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'iqcollection')
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'IQ7amo') # owner username without @
